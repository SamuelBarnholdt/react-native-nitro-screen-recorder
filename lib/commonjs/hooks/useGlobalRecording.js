...
const useGlobalRecording = props => {
  ...
  const wasRecordingRef = (0, _react.useRef)(false);
    ...
    const unsubscribe = (0, _functions.addScreenRecordingListener)({
      ...
      listener: async event => {
        ...
        if (event.reason === 'began') {
          ...
          let file = (0, _functions.retrieveLastGlobalRecording)();
          const deadline = Date.now() + 15_000;
          while (!file && Date.now() < deadline) {
            await delay(500);
            file = (0, _functions.retrieveLastGlobalRecording)();
          }
  ...
  (0, _react.useEffect)(() => {
    ...
    const pollStatus = () => {
      ...
      const currentlyRecording = (0, _functions.isScreenBeingRecorded)();
      ...
      const rawStatus = (0, _functions.getExtensionStatus)();
