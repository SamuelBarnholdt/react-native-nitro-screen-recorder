...
const NitroScreenRecorderHybridObject = NitroModules.createHybridObject('NitroScreenRecorder');
 ...
 * ```
 */
export async function startInAppRecording(input) {
  if (isAndroid) {
 ...
 * ```
 */
export async function stopInAppRecording() {
  if (isAndroid) {
 ...
 * ```
 */
export async function cancelInAppRecording() {
  if (isAndroid) {
 ...
 * ```
 */
export function startGlobalRecording(input) {
 ...
 * ```
 */
export function markChunkStart(chunkId) {
 ...
 * ```
 */
export function flushChunk(chunkId) {
  return NitroScreenRecorderHybridObject.markChunkStart(chunkId);
}
...
export async function finalizeChunk(options) {
  ...
  return NitroScreenRecorderHybridObject.finalizeChunk(settledTimeMs, options?.chunkId);
}
 ...
 * ```
 */
export function retrieveLastGlobalRecording() {
 ...
 * ```
 */
export function retrieveGlobalRecording(chunkId) {
 ...
 * ```
 */
export function addBroadcastPickerListener(listener) {
 ...
 * ```
 */
export function isScreenBeingRecorded() {
  if (Platform.OS === 'android') {
 ...
 * ```
 */
export function clearExtensionLogs() {
  if (Platform.OS === 'android') {
    return;
  }
 ...
 * ```
 */
export function getExtensionAudioMetrics() {
  if (Platform.OS === 'android') {
 ...
 * ```
 */
export function clearExtensionAudioMetrics() {
  if (Platform.OS === 'android') {
    return;
  }
