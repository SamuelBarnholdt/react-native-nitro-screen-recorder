...
class NitroScreenRecorder: HybridNitroScreenRecorderSpec {
  ...
  /**
   ...
   Uses token-based acknowledgment to ensure the extension has processed the mark request
   before returning. This prevents race conditions with subsequent operations.
   
   - Parameter chunkId: Optional identifier for this chunk. Used for guaranteed correct retrieval.
   - Returns: Promise resolving to elapsed milliseconds for the operation
   - Throws: RecorderError if extension does not acknowledge within timeout
   */
