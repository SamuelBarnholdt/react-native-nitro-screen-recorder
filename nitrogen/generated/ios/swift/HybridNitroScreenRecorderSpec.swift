...
public protocol HybridNitroScreenRecorderSpec_protocol: HybridObject {
  ...
  func addScreenRecordingListener(ignoreRecordingsInitiatedElsewhere: Bool, callback: @escaping (_ event: ScreenRecordingEvent) -> Void) throws -> Double
  ...
  func markChunkStart(chunkId: String?) throws -> Void
...
public extension HybridNitroScreenRecorderSpec_protocol {
